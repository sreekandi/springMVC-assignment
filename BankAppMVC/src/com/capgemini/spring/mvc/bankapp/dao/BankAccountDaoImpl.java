...
public class BankAccountDaoImpl implements BankAccountDao{
	...
	public boolean addNewBankAccount(BankAccount account) {
		int result=jdbcTemplate.update("INSERT INTO bankaccount (customer_name,account_type,account_balance) VALUES(?,?,?)",
	...
	public double getBalance(long accountId) {
		double balance = -1;
		 balance  = jdbcTemplate.queryForObject("SELECT account_balance FROM bankaccount WHERE account_id=?" , 
	...
	public void updateBalance(long accountId, double newBalance) {
		jdbcTemplate.update("UPDATE bankaccount SET account_balance=? WHERE account_id=?",new Object[]{newBalance,accountId});
	...
	public boolean deleteBankAccount(long accountId) {
		int result =jdbcTemplate.update("DELETE FROM bankaccount WHERE account_id= ? ",new Object[]{accountId});
	...
	public BankAccount searchAccountDetails(long accountId) throws AccountNotFoundException {
		String query1 = "SELECT * FROM bankaccount WHERE account_id=" + accountId;
